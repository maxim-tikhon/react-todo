	...
	return (
		<div className={styles.todoFooter}>
			...
			<div className={styles.buttonsContainer}>
				<LinkButton isActive={filter===FILTER.ALL} onClick={() => onChangeFilter(FILTER.ALL)}>All</LinkButton>
				<LinkButton isActive={filter===FILTER.ACTIVE} onClick={() => onChangeFilter(FILTER.ACTIVE)}>Active</LinkButton>
				<LinkButton isActive={filter===FILTER.COMPLETED} onClick={() => onChangeFilter(FILTER.COMPLETED)}>Completed</LinkButton>
			</div>
